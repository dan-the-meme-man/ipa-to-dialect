...
for e in range(epochs):
    ...
    shuffle(test_data) # randomize order
    ...
    for i in range(num_batches):
        ...
        # preprocess data
        test_items = test_data[i * batch_size : (i + 1) * batch_size]
        ...
        labels = torch.tensor([[test_item[1] for test_item in test_items]])
